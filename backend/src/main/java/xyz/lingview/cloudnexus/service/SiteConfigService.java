...
public interface SiteConfigService {
    ...
    default xyz.lingview.cloudnexus.domain.MailConfig getMailConfig() {
        SiteConfig siteConfig = getSiteConfig();
        if (siteConfig != null) {
            xyz.lingview.cloudnexus.domain.MailConfig mailConfig = new xyz.lingview.cloudnexus.domain.MailConfig();
