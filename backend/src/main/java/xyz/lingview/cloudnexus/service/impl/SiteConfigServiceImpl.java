package xyz.lingview.cloudnexus.service.impl;
...
import xyz.lingview.cloudnexus.domain.SiteConfig;
import xyz.lingview.cloudnexus.dto.request.HeroDTO;
import xyz.lingview.cloudnexus.mapper.SiteConfigMapper;
import xyz.lingview.cloudnexus.service.SiteConfigService;
...
public class SiteConfigServiceImpl implements SiteConfigService {
    ...
    public SiteConfig getSiteConfig() {
        try {
            String siteConfigJson = stringRedisTemplate.opsForValue().get("cloudnexus:site_config");
    ...
    private void updateRedisCache(SiteConfig siteConfig) {
        try {
            ...
            stringRedisTemplate.opsForValue().set("cloudnexus:site_config", siteConfigJson);
