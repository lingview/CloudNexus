package xyz.lingview.cloudnexus.util;
...
public class SiteConfigUtil {
    ...
    /**
     * 从Redis中的cloudnexus:site_config获取指定字段的值
     * @param fieldKey 字段名
     * @return 字段值，如果不存在或出错则返回null
     */
    public String getSiteConfigField(String fieldKey) {
        try {
            String siteConfigJson = redisTemplate.opsForValue().get("cloudnexus:site_config");
    ...
    /**
     * 从Redis中的cloudnexus:site_config获取站点名称
    ...
    /**
     * 从Redis中的cloudnexus:site_config获取版权信息
    ...
    /**
     * 从Redis中的cloudnexus:site_config获取站点图标
    ...
    /**
     * 从Redis中的cloudnexus:site_config获取是否启用通知
